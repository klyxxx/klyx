-- ============================================================
-- KLYX 13.34e CANONICAL BASELINE STAGING
--
-- Source:
-- Supabase linked production PUBLIC schema dump.
--
-- Purpose:
-- Prove that a completely fresh local Supabase database can
-- reconstruct the current KLYX public schema from one baseline.
--
-- THIS FILE IS NOT YET AN OFFICIAL PRODUCTION MIGRATION.
-- DO NOT DB PUSH THIS FILE TO PRODUCTION.
-- ============================================================
