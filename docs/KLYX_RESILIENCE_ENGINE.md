...
When the serialized E2E queue is busy, certification must be retriggered only after the active and pending sibling runs have cleared; repeated head commits are not a substitute for queue discipline.
