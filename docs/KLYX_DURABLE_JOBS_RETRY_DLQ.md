...
Scheduling time is intentionally outside the fingerprint. Repeated enqueue
calls with the same semantic work may arrive at slightly different times
without creating false idempotency conflicts. A duplicate enqueue never
