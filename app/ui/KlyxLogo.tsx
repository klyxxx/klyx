...
export default function KlyxLogo({
  ...
  return (
    ...
    >
      <span className="relative grid h-11 w-11 shrink-0 place-items-center overflow-hidden rounded-[15px] bg-white shadow-[0_12px_34px_rgba(109,40,217,0.28)] ring-1 ring-black/5 transition duration-300 group-hover:-translate-y-0.5 group-hover:shadow-[0_16px_40px_rgba(109,40,217,0.38)]">
