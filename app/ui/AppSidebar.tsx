  ...
  return (
    <>
      ...
      <aside
        ...
        className="fixed inset-y-0 left-0 z-40 isolate hidden h-dvh w-[280px] shrink-0 flex-col border-r border-border bg-background lg:flex dark:border-white/8 dark:bg-zinc-950"
      >
