...
function inputClassName(): string {
  return "w-full rounded-xl border border-border bg-background px-4 py-3 text-foreground outline-none transition placeholder:text-muted-foreground focus:border-[#2563EB]/50 focus:ring-4 focus:ring-[#2563EB]/10";
}
    ...
    return (
      <main className="grid min-h-[55vh] place-items-center bg-background text-foreground">
        <div className="text-center">
          <LoaderCircle className="mx-auto animate-spin text-[#2563EB]" size={36} />
      ...
      <div className="mx-auto min-w-0 max-w-6xl">
        ...
        <div className="mt-7 grid gap-6 lg:grid-cols-[minmax(0,1fr)_280px]">
          <div className="min-w-0 space-y-6">
                      ...
                      availableServiceMatches.map((service) => {
                        ...
                        return (
                          <button
                            ...
                            className="flex w-full items-center justify-between gap-3 rounded-xl px-4 py-3 text-left transition hover:bg-[#2563EB]/8 focus-visible:bg-[#2563EB]/8 focus-visible:outline-none"
                          >
                            <span className="font-semibold">{label}</span>
                            <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-[#2563EB] text-white">
                              <Plus size={16} />
                            </span>
                          </button>
                        );
            ...
            >
              <label className="flex cursor-pointer flex-col items-center justify-center rounded-2xl border border-dashed border-border bg-background px-6 py-9 text-center transition hover:border-[#2563EB]/50 hover:bg-[#2563EB]/[0.03]">
                {uploadingGallery ? (
                  <LoaderCircle className="animate-spin text-[#2563EB]" size={30} />
                ) : (
                  <ImagePlus className="text-[#2563EB]" size={30} />
                )}
            ...
            >
              <div className="grid gap-4 sm:grid-cols-[1fr_auto]">
                ...
                <label className="inline-flex min-h-12 cursor-pointer items-center justify-center gap-2 rounded-xl bg-[#2563EB] px-5 py-3 font-semibold text-white transition hover:opacity-90">
                  {uploadingDocument ? (
          ...
          <aside className="space-y-4 lg:sticky lg:top-6 lg:self-start">
            <section className="rounded-2xl border border-border bg-card p-5">
              <div className="flex items-center justify-between gap-4">
                ...
                <ShieldCheck size={30} className="text-[#2563EB]" />
              </div>
            ...
            <section className="rounded-2xl border border-border bg-card p-5">
              ...
              <button
                ...
                disabled={saving}
                className="mt-5 inline-flex min-h-12 w-full items-center justify-center gap-2 rounded-xl bg-[#2563EB] px-4 py-3 font-semibold text-white transition hover:opacity-90 disabled:opacity-50"
              >
                {saving ? (
                  <LoaderCircle className="animate-spin" size={18} />
                ) : (
            ...
            >
              ...
              <ChevronRight size={19} className="text-[#2563EB]" />
            </Link>
          </aside>
        </div>
      </div>
  ...
  return (
    <div className="space-y-7 rounded-2xl border border-border bg-background p-5 sm:p-6">
      ...
      <div className="border-t border-border pt-6">
        <div className="flex items-center gap-2">
          <MapPin size={19} className="text-[#2563EB]" />
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          {service.serviceArea.map((zone) => (
            <span
              key={zone}
              className="inline-flex items-center gap-2 rounded-full border border-[#2563EB]/25 bg-[#2563EB]/8 px-3 py-1.5 text-sm text-[#2563EB] dark:text-[#2563EB]"
            >
              {zone}
              <button
                type="button"
      ...
      <div className="border-t border-border pt-6">
        <div className="flex items-center gap-2">
          <Clock3 size={19} className="text-[#2563EB]" />
  ...
  return (
    <section className="rounded-2xl border border-border bg-card p-5 sm:p-7">
      <div className="mb-6 flex items-start gap-4">
        <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-[#2563EB]/8 text-[#2563EB]">
          {icon}
        </span>
        <div>
