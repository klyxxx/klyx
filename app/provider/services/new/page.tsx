  ...
  return (
    <main className="klyx-page">
      ...
      <section className="mt-8 max-w-3xl">
        <div className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-[0.16em] text-[#2563EB]">
        ...
        <section className="klyx-card p-6 sm:p-8">
          ...
          <form onSubmit={submitProposal} className="mt-7 space-y-5">
            ...
            <button
              type="submit"
              disabled={sending}
              className="inline-flex h-12 items-center gap-2 rounded-2xl bg-[#2563EB] px-5 text-sm font-bold text-white transition hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-60"
            >
              <Send size={18} />
        ...
        <section className="space-y-6">
          <article className="klyx-card p-6">
            <div className="flex items-start gap-3">
              <ShieldAlert className="mt-0.5 text-[#2563EB]" />
              <div>
                <h2 className="font-semibold">{t("validationTitle")}</h2>
          ...
          <article className="klyx-card p-6">
            <div className="flex items-center gap-3">
              <BadgeCheck className="text-[#2563EB]" />
              <h2 className="text-lg font-semibold">{t("myProposals")}</h2>
            </div>
                  ...
                  return (
                    ...
                    >
                      <div className="flex flex-wrap items-start justify-between gap-3">
                        <div>
                          <p className="font-semibold">{proposal.proposedName}</p>
