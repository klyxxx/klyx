...
type ClientStep = {
  title: KlyxOnboardingOverviewMessageKey;
  description: KlyxOnboardingOverviewMessageKey;
  href: string;
  button: KlyxOnboardingOverviewMessageKey;
  icon: typeof UserRound;
};

const CLIENT_STEPS: ClientStep[] = [
  {
    title: "clientProfileTitle",
    description: "clientProfileDescription",
    href: "/profile",
    button: "clientProfileButton",
    icon: UserRound,
  },
  {
    title: "clientNeedTitle",
    description: "clientNeedDescription",
    href: "/assistant/market",
    button: "clientNeedButton",
    icon: Sparkles,
  },
  {
    title: "clientCompareTitle",
    description: "clientCompareDescription",
    href: "/search",
    button: "clientCompareButton",
    icon: Search,
  },
];

export default function OnboardingOverview({ provider, firstName }: Props) {
  const { locale } = useKlyxLocale();
  const t = (key: KlyxOnboardingOverviewMessageKey) =>
    translateKlyxOnboardingOverview(locale, key);
      ...
      <div className="mx-auto max-w-6xl">
        ...
        >
          ...
          <div className="relative z-10 max-w-4xl">
            ...
            <h1 className="mt-5 text-3xl font-black tracking-[-0.05em] sm:text-5xl">
              {firstName
                ? formatKlyxOnboardingWelcome(locale, firstName)
                : t("welcomeKlyx")}
            </h1>

            <p className="mt-4 max-w-3xl text-sm leading-7 text-white/70 sm:text-base">
              {provider ? t("providerIntro") : t("clientIntro")}
            </p>
            ...
            <div className="mt-7 flex flex-wrap gap-3">
              ...
              <span className="inline-flex min-h-12 items-center gap-2 rounded-2xl border border-white/10 bg-white/[0.06] px-5 text-sm font-black text-white/80">
                <BadgeCheck size={17} />
                {provider ? t("providerPath") : t("clientPath")}
              </span>
            </div>
          </div>
        </section>
        ...
        <section className="mt-8">
          ...
          <h2 className="mt-2 text-2xl font-black tracking-[-0.035em] sm:text-3xl">
            {provider ? t("providerStart") : t("clientStart")}
          </h2>
            ...
            <>
              ...
              <div className="mt-6 grid gap-4 md:grid-cols-2">
                ...
                >
                  ...
                  <div>
                    <p className="font-black">{t("providerOpportunitiesTitle")}</p>
                ...
                >
                  ...
                  <div>
                    <p className="font-black">{t("providerAssistantTitle")}</p>
              ...
              {CLIENT_STEPS.map((step, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <h3 className="mt-6 text-lg font-black">{t(step.title)}</h3>
