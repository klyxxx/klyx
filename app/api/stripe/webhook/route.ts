...
import { reconcilePlatformHeldBookingRefundFromStripe } from "@/lib/platform-held-booking-refund-server";
  ...
  try {
    ...
    switch (event.type) {
      ...
      case "refund.failed": {
        ...
        await reconcilePlatformHeldBookingRefundFromStripe(refund);
      ...
      case "account.updated": {
        ...
        await updateConnectedAccount(stripe, account);
        break;
      }
