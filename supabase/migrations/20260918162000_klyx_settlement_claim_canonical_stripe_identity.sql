-- KLYX PLATFORM-HELD SETTLEMENT — #799 CANONICAL STRIPE IDENTITY
--
-- Append-only Mission 3 integration correction.
-- Settlement release authority is public.account_stripe_connect_identities,
-- never legacy profile Stripe fields nor superseded accounts.stripe_* columns.
...
comment on function public.klyx_claim_booking_settlement_release(uuid, uuid) is
  'Server-only fail-closed release claim. Uses #799 account_stripe_connect_identities as the sole canonical Stripe routing authority.';
