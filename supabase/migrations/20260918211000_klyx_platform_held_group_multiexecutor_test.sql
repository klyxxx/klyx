...
revoke all on function public.klyx_claim_platform_held_group_checkout(uuid, uuid) from public, anon, authenticated;
revoke all on function public.klyx_attach_platform_held_group_checkout(uuid, uuid, text) from public, anon, authenticated;
revoke all on function public.klyx_release_expired_platform_held_group_checkout(uuid, text) from public, anon, authenticated;
revoke all on function public.klyx_mark_platform_held_group_paid(uuid, text, text, text, bigint, text) from public, anon, authenticated;
revoke all on function public.klyx_claim_platform_held_group_member_release(uuid, uuid) from public, anon, authenticated;
revoke all on function public.klyx_finalize_platform_held_group_member_release(uuid, uuid, text) from public, anon, authenticated;
revoke all on function public.klyx_reconcile_platform_held_group_member_release(uuid, text) from public, anon, authenticated;
revoke all on function public.klyx_reopen_platform_held_group_member_release_after_no_transfer(uuid) from public, anon, authenticated;
revoke all on function public.klyx_fail_platform_held_group_member_release(uuid, uuid, text, text) from public, anon, authenticated;
revoke all on function public.klyx_mark_platform_held_group_review(uuid, text, text) from public, anon, authenticated;
revoke all on function public.klyx_mark_platform_held_group_member_review(uuid, text, text) from public, anon, authenticated;
revoke all on function public.klyx_create_platform_held_group_refund_plan(uuid, text, bigint, text, jsonb) from public, anon, authenticated;
revoke all on function public.klyx_finalize_platform_held_group_member_reversal(uuid, text, text, bigint) from public, anon, authenticated;
revoke all on function public.klyx_mark_platform_held_group_refund_review(uuid, text, text) from public, anon, authenticated;
revoke all on function public.klyx_mark_platform_held_group_refund_allocation_review(uuid, text, text) from public, anon, authenticated;
revoke all on function public.klyx_mark_platform_held_group_refund_inflight(uuid) from public, anon, authenticated;
revoke all on function public.klyx_fail_platform_held_group_refund(uuid, text, text) from public, anon, authenticated;
...
grant execute on function public.klyx_prepare_platform_held_group_settlement(uuid, uuid, uuid, text, text, bigint, bigint, bigint, text, jsonb) to service_role;
grant execute on function public.klyx_claim_platform_held_group_checkout(uuid, uuid) to service_role;
grant execute on function public.klyx_attach_platform_held_group_checkout(uuid, uuid, text) to service_role;
grant execute on function public.klyx_release_expired_platform_held_group_checkout(uuid, text) to service_role;
grant execute on function public.klyx_mark_platform_held_group_paid(uuid, text, text, text, bigint, text) to service_role;
grant execute on function public.klyx_claim_platform_held_group_member_release(uuid, uuid) to service_role;
grant execute on function public.klyx_finalize_platform_held_group_member_release(uuid, uuid, text) to service_role;
grant execute on function public.klyx_reconcile_platform_held_group_member_release(uuid, text) to service_role;
grant execute on function public.klyx_reopen_platform_held_group_member_release_after_no_transfer(uuid) to service_role;
grant execute on function public.klyx_fail_platform_held_group_member_release(uuid, uuid, text, text) to service_role;
grant execute on function public.klyx_mark_platform_held_group_review(uuid, text, text) to service_role;
grant execute on function public.klyx_mark_platform_held_group_member_review(uuid, text, text) to service_role;
grant execute on function public.klyx_create_platform_held_group_refund_plan(uuid, text, bigint, text, jsonb) to service_role;
grant execute on function public.klyx_finalize_platform_held_group_member_reversal(uuid, text, text, bigint) to service_role;
grant execute on function public.klyx_mark_platform_held_group_refund_review(uuid, text, text) to service_role;
grant execute on function public.klyx_mark_platform_held_group_refund_allocation_review(uuid, text, text) to service_role;
grant execute on function public.klyx_mark_platform_held_group_refund_inflight(uuid) to service_role;
grant execute on function public.klyx_fail_platform_held_group_refund(uuid, text, text) to service_role;
grant execute on function public.klyx_finalize_platform_held_group_refund(uuid, text, bigint, text) to service_role;
