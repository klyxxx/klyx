...
const MESSAGES: Record<KlyxFounderFinalCheckLocale, Dictionary> = {
  fr: {
    backFounder: "Console Founder", badge: "Étape 11.8", title: "Validation finale Founder",
    description: "Dernier contrôle avant de fermer l’étape 11. Aucun compte ni donnée n’est modifié par cette page.",
    rerun: "Relancer", loadError: "Validation impossible pour le moment.", step: "Étape 11",
    readyTitle: "Étape 11 prête à être fermée", notReadyTitle: "Étape 11 à corriger", readyBadge: "READY", notReadyBadge: "NOT READY",
    ok: "OK", warnings: "Avertissements", blockers: "Blocages", nonBlocking: "NON BLOQUANT",
    validatedTitle: "Étape 11 validée", validatedDescription: "Founder, Client, Prestataire et Admin sont prêts. Les avertissements non bloquants peuvent être traités plus tard.",
  ...
  en: {
    backFounder: "Founder Console", badge: "Step 11.8", title: "Founder final validation",
    description: "Final check before closing step 11. This page does not modify any account or data.",
    rerun: "Run again", loadError: "Validation cannot run right now.", step: "Step 11",
    readyTitle: "Step 11 is ready to close", notReadyTitle: "Step 11 needs corrections", readyBadge: "READY", notReadyBadge: "NOT READY",
    ok: "OK", warnings: "Warnings", blockers: "Blockers", nonBlocking: "NON-BLOCKING",
    validatedTitle: "Step 11 validated", validatedDescription: "Founder, Client, Provider, and Admin are ready. Non-blocking warnings can be handled later.",
  ...
  nl: {
    backFounder: "Founder-console", badge: "Stap 11.8", title: "Definitieve Founder-validatie",
    description: "Laatste controle voordat stap 11 wordt afgesloten. Deze pagina wijzigt geen account of gegevens.",
    rerun: "Opnieuw uitvoeren", loadError: "De validatie kan momenteel niet worden uitgevoerd.", step: "Stap 11",
    readyTitle: "Stap 11 is klaar om af te sluiten", notReadyTitle: "Stap 11 vereist correcties", readyBadge: "KLAAR", notReadyBadge: "NIET KLAAR",
    ok: "OK", warnings: "Waarschuwingen", blockers: "Blokkades", nonBlocking: "NIET BLOKKEREND",
    validatedTitle: "Stap 11 gevalideerd", validatedDescription: "Founder, Klant, Dienstverlener en Admin zijn klaar. Niet-blokkerende waarschuwingen kunnen later worden behandeld.",
  ...
  de: {
    backFounder: "Founder-Konsole", badge: "Schritt 11.8", title: "Abschließende Founder-Validierung",
    description: "Letzte Prüfung vor dem Abschluss von Schritt 11. Diese Seite ändert weder Konten noch Daten.",
    rerun: "Erneut ausführen", loadError: "Die Validierung kann derzeit nicht ausgeführt werden.", step: "Schritt 11",
    readyTitle: "Schritt 11 kann abgeschlossen werden", notReadyTitle: "Schritt 11 muss korrigiert werden", readyBadge: "BEREIT", notReadyBadge: "NICHT BEREIT",
    ok: "OK", warnings: "Warnungen", blockers: "Blocker", nonBlocking: "NICHT BLOCKIEREND",
    validatedTitle: "Schritt 11 validiert", validatedDescription: "Founder, Kunde, Anbieter und Admin sind bereit. Nicht blockierende Warnungen können später bearbeitet werden.",
