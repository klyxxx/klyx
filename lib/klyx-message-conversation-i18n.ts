...
> = {
  fr: {
    ...
    backDashboardFull: "Retour au tableau de bord",
    back: "Retour",
  ...
  en: {
    ...
    backDashboardFull: "Back to dashboard",
    back: "Back",
  ...
  nl: {
    ...
    backDashboardFull: "Terug naar dashboard",
    back: "Terug",
  ...
  de: {
    ...
    backDashboardFull: "Zurück zum Dashboard",
    back: "Zurück",
