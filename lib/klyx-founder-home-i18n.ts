...
export const KLYX_FOUNDER_HOME_MESSAGE_KEYS = [
  ...
  "adminTitle", "adminDescription", "openAdmin", "analytics", "businessValue",
...
const MESSAGES: Record<KlyxFounderHomeLocale, Dictionary> = {
  ...
  en: {
    ...
    adminTitle: "Super Admin", adminDescription: "Admin Center, verifications, skills, disputes, finance, and launch controls.", openAdmin: "Open Admin", analytics: "Product analytics", businessValue: "Real economics",
  ...
  nl: {
    ...
    adminTitle: "Super Admin", adminDescription: "Beheercentrum, verificaties, vaardigheden, geschillen, financiën en lanceringscontrole.", openAdmin: "Admin openen", analytics: "Productanalyse", businessValue: "Reële economie",
  ...
  de: {
    ...
    adminTitle: "Super Admin", adminDescription: "Admin-Center, Verifizierungen, Kompetenzen, Streitfälle, Finanzen und Launch-Kontrolle.", openAdmin: "Admin öffnen", analytics: "Produktanalyse", businessValue: "Reale Wirtschaftlichkeit",
