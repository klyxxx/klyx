...
const dictionaries: Record<KlyxProfilePageLocale, Dictionary> = {
  ...
  es: {
    ...
    lastName: "Apellidos",
    age: "Edad",
    agePlaceholder: "Ejemplo: 28",
    city: "Ciudad",
    cityPlaceholder: "Ejemplo: Bruselas",
    saving: "Guardando...",
    save: "Guardar mis datos",
    manageProviderProfile: "Gestionar mi perfil profesional",
    settings: "Configuración",
    loadFailed: "No se ha podido cargar el perfil.",
    profileNotFound: "No se ha encontrado el perfil de KLYX.",
    unauthenticated: "Inicia sesión para acceder a tu perfil.",
    accessDenied: "Se ha denegado el acceso a este perfil.",
    identityRequired: "El nombre, los apellidos y la ciudad son obligatorios.",
    ...
    avatarMissing: "No se ha proporcionado ninguna imagen.",
    avatarTypeInvalid: "Elige una imagen JPG, PNG o WEBP.",
    avatarTooLarge: "La foto debe tener un tamaño máximo de 5 MB.",
    uploadFailed: "No se ha podido subir la foto.",
    avatarUpdated: "Foto de perfil actualizada.",
    avatarUnavailable: "La foto guardada no está disponible.",
  },
};
