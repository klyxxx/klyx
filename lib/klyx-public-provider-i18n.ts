...
const DICTIONARIES: Record<KlyxPublicProviderLocale, Dictionary> = {
  fr: {
    ...
    score: "KLYX Score",
    assistantChoice: "Pourquoi KLYX le recommande",
    confidenceLabel: "Confiance",
    priceLabel: "Prix",
    availabilityLabel: "Disponibilité",
    otherServices: "Voir ses autres services vérifiés",
    trustDetails: "Voir les avis et les signaux de confiance",
    galleryTitle: "Réalisations et environnement",
    galleryAlt: "Réalisation du prestataire",
    servicesTitle: "Service proposé",
  ...
  en: {
    ...
    score: "KLYX Score",
    assistantChoice: "Why KLYX recommends this provider",
    confidenceLabel: "Trust",
    priceLabel: "Price",
    availabilityLabel: "Availability",
    otherServices: "See other verified services",
    trustDetails: "See reviews and trust signals",
  ...
  nl: {
    ...
    score: "KLYX Score",
    assistantChoice: "Waarom KLYX deze dienstverlener aanbeveelt",
    confidenceLabel: "Vertrouwen",
    priceLabel: "Prijs",
    availabilityLabel: "Beschikbaarheid",
    otherServices: "Andere geverifieerde diensten bekijken",
    trustDetails: "Reviews en vertrouwenssignalen bekijken",
    galleryTitle: "Realisaties en werkomgeving",
    galleryAlt: "Realisatie van de dienstverlener",
    servicesTitle: "Aangeboden dienst",
  ...
  de: {
    ...
    score: "KLYX Score",
    assistantChoice: "Warum KLYX diesen Anbieter empfiehlt",
    confidenceLabel: "Vertrauen",
    priceLabel: "Preis",
    availabilityLabel: "Verfügbarkeit",
    otherServices: "Weitere verifizierte Dienstleistungen ansehen",
    trustDetails: "Bewertungen und Vertrauenssignale ansehen",
    galleryTitle: "Arbeiten und Umfeld",
    galleryAlt: "Arbeit des Anbieters",
    servicesTitle: "Angebotene Dienstleistung",
